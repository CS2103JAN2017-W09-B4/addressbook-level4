...
public class LogicManagerTest {
    ...
    private void assertCommandSuccess(String inputCommand, String expectedMessage,
                                      ...
                                      List<? extends ReadOnlyAddressBook> expectedShownList) {
    ...
    private void assertCommandFailure(String inputCommand, String expectedMessage) {
        ...
        List<ReadOnlyAddressBook> expectedShownList = new ArrayList<>(model.getFilteredPersonList());
    ...
    public void execute_list_showsAllPersons() throws Exception {
        ...
        List<? extends ReadOnlyAddressBook> expectedList = expectedAB.getPersonList();
