...
.cardPaneP0 {
    ...
    -fx-border-width: 0 0 1 15;
}

.cardPaneP1 {
    -fx-background-color: transparent;
    -fx-border-color: #bbbbbb #bbbbbb #bbbbbb #FA3833; /*Priority 1*/
    -fx-border-width: 0 0 1 15;
}

.cardPaneP2 {
    -fx-background-color: transparent;
    -fx-border-color: #bbbbbb #bbbbbb #bbbbbb #FA8E63; /*Priority 2*/
    -fx-border-width: 0 0 1 15;
}

.cardPaneP3 {
    -fx-background-color: transparent;
    -fx-border-color: #bbbbbb #bbbbbb #bbbbbb #66bbbb; /*Priority 3*/
    -fx-border-width: 0 0 1 15;
}

.cardPaneP4 {
    -fx-background-color: transparent;
    -fx-border-color: #bbbbbb #bbbbbb #bbbbbb #66dd99; /*Priority 4*/
    -fx-border-width: 0 0 1 15;
}
